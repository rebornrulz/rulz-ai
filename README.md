...
Open a terminal in the root directory of your local Rulz-AI repository and run:
...
In the 1st migration file `supabase/migrations/20220810154536_employee.sql` you will need to replace 2 values with the values you got above:

- `project_url` (line 53): `http://supabase_kong_rulz-ai:8000` (default) can remain unchanged if you don't change your `project_id` in the `config.toml` file
...
Create a new repository for your hosted instance of Rulz-AI on GitHub and push your code to it.
