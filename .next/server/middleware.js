...
;// CONCATENATED MODULE: ./node_modules/@vercel/edge-config-fs/index.edge.js
function readFile() {
    throw new Error("readFile cannot be called from the edge runtime.");
}

;// CONCATENATED MODULE: ./node_modules/@vercel/edge-config/dist/index.js
...
async function E(e) {
    ...
    try {
        let n = await readFile(`/opt/edge-config/${e.id}.json`, "utf-8");
        return JSON.parse(n);
    } catch  {
        return null;
    }
